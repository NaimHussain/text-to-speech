...
#Top Frame
Top_frame=Frame(root,bg="white",width=900,heigh=100)
Top_frame.place(x=0,y=0)



#img= Image.open("mike18.jpg")
#resized_image= img.resize((100,100))
Logo=PhotoImage(file="mike20.png")
...
text_area=Text(root,font="Roboto 20",bg="white")
text_area.place(x=10,y=150,width=500,height=250)

Label(root,text="VOICE",font="arial 15 bold",bg="#305065",fg="white").place(x=600,y=160)
...
imageicon=PhotoImage("speaker.png")
...
imageicon2=PhotoImage("speaker.png")
